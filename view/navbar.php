      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto mb-2 pe-5 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link text-white" aria-current="page" href="ver_reservas.php">Reservas</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-white" aria-current="page" href="reportes.php">Reportes</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-white" aria-current="page" href="usuarios.php">Usuarios</a>
            </li>
